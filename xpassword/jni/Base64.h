...
class Base64
{
	public:
		 ...
		 */
		static ulong decodeBuffer(const char * in, byte * out, ulong inSize);
		 ...
		 */
		static void decodeFile(const char * inFile, const char * outFile) ;
	...
	private:
		 ...
		 *				alphabet
		 */
		static uint decodeBlock(const char in[4], byte out[3]) ;
